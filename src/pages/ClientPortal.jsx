          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-[#D9C8A9]/80 bg-white/70 p-6 shadow-[0_22px_70px_rgba(31,25,20,0.08)] sm:p-8 lg:p-10">
            ...
            <div className="relative space-y-6">
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                {[
                  ['မေးမြန်းချက်ဖြင့် စတင်', 'Facebook သို့မဟုတ် ဖုန်းဖြင့် စတင်မေးမြန်းနိုင်ပါသည်။'],
                  ['KTM က ဈေးနှုန်းတွက်', 'ဈေးနှုန်းနှင့် အစီအစဉ်ကို team က စုစည်းတွက်ချက်ပေးပါသည်။'],
                  ['အရောက်ပို့ဝန်ဆောင်မှု', 'လက်ခံခြင်းမှ အရောက်ပို့ခြင်းအထိ တစ်ဆက်တည်း စီမံပါသည်။'],
                ].map(([title, text]) => (
