...
import {
    Plane, Package, ShoppingBag, ArrowRight, CheckCircle,
    MapPin, Clock, Shield, Globe, Menu, X, Search, Truck,
    Star, Users, HelpCircle, ChevronDown
} from 'lucide-react';
...
export default function LandingPage() {
    ...
    const handleTrack = async (e) => {
        ...
        setIsTracking(true);
        try {
            const results = await base44.entities.Shipment.filter({ tracking_number: trackingNumber.trim() });
            if (results.length > 0) {
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100 transition-all duration-300">
                    ...
                    <div className="flex items-center justify-between h-20">
                        ...
                        <div className="flex items-center gap-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-medium text-slate-500 uppercase tracking-wider">Express Logistics</p>
                            </div>
                        </div>
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            ...
                            <div className="flex items-center gap-3 ml-4">
                                <Link to="/ClientPortal">
                                    <Button variant="ghost" className="font-medium hover:bg-blue-50 hover:text-blue-600">Sign In</Button>
                                </Link>
                                <Link to="/ClientPortal">
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden bg-white border-t border-slate-100 p-4 space-y-4 shadow-xl absolute w-full animate-in slide-in-from-top-5">
                        <a href="#services" className="block text-sm font-medium text-slate-600 p-2 hover:bg-slate-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>Services</a>
                        <a href="#how-it-works" className="block text-sm font-medium text-slate-600 p-2 hover:bg-slate-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>How it Works</a>
                        <a href="#testimonials" className="block text-sm font-medium text-slate-600 p-2 hover:bg-slate-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>Reviews</a>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8 relative z-10">
                            ...
                            <p className="text-lg text-slate-600 max-w-xl leading-relaxed">
                                The most reliable cargo service connecting Thailand and Myanmar.
                                We handle everything from personal shopping to bulk commercial shipments
                                with real-time tracking and premium support.
                            </p>
            ...
            <section id="services" className="py-24 bg-slate-50 relative">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-2xl mx-auto mb-16">
                        ...
                        <p className="text-slate-600 text-lg">Tailored logistics solutions designed for individuals and businesses.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 group">
                            <CardContent className="p-8">
                                ...
                                <p className="text-slate-600 mb-6 leading-relaxed">
                                    Door-to-door delivery from Bangkok to Yangon. We handle customs, packaging, and insurance for your peace of mind.
                                </p>
                                ...
                                <Button variant="outline" className="w-full group-hover:bg-blue-50 group-hover:text-blue-600 group-hover:border-blue-200">Learn More</Button>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 relative overflow-hidden group">
                            <div className="absolute top-0 right-0 bg-orange-500 text-white text-xs font-bold px-3 py-1 rounded-bl-xl z-10">POPULAR</div>
                            <CardContent className="p-8">
                                ...
                                <p className="text-slate-600 mb-6 leading-relaxed">
                                    Can't shop in Thailand? Send us the links, and we'll buy, inspect, and ship the items directly to you.
                                </p>
                                <ul className="space-y-3 mb-8">
                                    <li className="flex items-center gap-2 text-sm text-slate-600">
                                ...
                                <Button className="w-full bg-slate-900 text-white hover:bg-slate-800 group-hover:shadow-lg">Start Shopping</Button>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 group">
                            <CardContent className="p-8">
                                ...
                                <p className="text-slate-600 mb-6 leading-relaxed">
                                    Scalable solutions for businesses. Bulk shipping, warehousing, and inventory management for your supply chain.
                                </p>
                                <ul className="space-y-3 mb-8">
                                    <li className="flex items-center gap-2 text-sm text-slate-600">
                                ...
                                <Button variant="outline" className="w-full group-hover:bg-purple-50 group-hover:text-purple-600 group-hover:border-purple-200">Contact Sales</Button>
                            </CardContent>
                        </Card>
                    </div>
                </div>
            ...
            <section id="how-it-works" className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-12 relative">
                        ...
                        {[
                            { icon: Users, title: "1. Register & Get Address", desc: "Sign up to get your unique shipping address in Bangkok." },
                            { icon: ShoppingBag, title: "2. Shop & Ship", desc: "Send your purchases to our warehouse. We receive and inspect them." },
                            { icon: Package, title: "3. We Deliver", desc: "We consolidate your items and ship them directly to your door in Yangon." }
                        ].map((step, idx) => (
            ...
            <section id="testimonials" className="py-24 bg-slate-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-2xl mx-auto mb-16">
                        ...
                        <p className="text-slate-600 text-lg">Don't just take our word for it. Here's what our customers say.</p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            { name: "Thandar Hlaing", role: "Online Seller", text: "KTM Cargo has been a game changer for my business. Fast shipping and great rates!" },
                            { name: "Kyaw Zin", role: "Gadget Enthusiast", text: "I buy electronics from Thailand all the time. The 'Buy for Me' service is super convenient." },
                            { name: "May Myat", role: "Fashion Boutique Owner", text: "Reliable and professional. My stock always arrives on time and in perfect condition." }
                        ].map((review, idx) => (
                ...
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="item-1">
                            ...
                            <AccordionContent>
                                Our standard shipping from Bangkok to Yangon takes 3-5 business days. We have daily departures to ensure the fastest delivery.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-2">
                            <AccordionTrigger>What are your shipping rates?</AccordionTrigger>
                            <AccordionContent>
                                Our rates start at ฿150 per kg for general goods. For bulk shipments over 100kg, we offer special discounted rates. Please use our Price Calculator in the portal for an exact quote.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-3">
                            <AccordionTrigger>Do you offer insurance?</AccordionTrigger>
                            <AccordionContent>
                                Yes! Every shipment includes basic insurance coverage up to ฿5,000. Additional insurance is available for high-value items at a small fee.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-4">
                            <AccordionTrigger>How does 'Buy for Me' work?</AccordionTrigger>
                            <AccordionContent>
                                Simply send us the link of the product you want to buy. We will purchase it, inspect it at our warehouse, and ship it to you. We charge a 10% service fee on the product value.
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-[2.5rem] p-12 lg:p-24 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <div className="relative z-10 max-w-3xl mx-auto">
                            <h2 className="text-3xl lg:text-5xl font-bold text-white mb-6">Ready to ship your first package?</h2>
                            <p className="text-blue-100 text-lg mb-10">Join thousands of happy customers who trust KTM Cargo for their logistics needs. Sign up today and get 10% off your first shipment.</p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <Link to="/ClientPortal">
                                    <Button variant="outline" className="border-blue-400 text-blue-100 hover:bg-blue-700 hover:text-white h-14 px-8 rounded-full text-lg font-medium w-full sm:w-auto">
                                        Contact Support
                                    </Button>
                                </Link>
                            </div>
                    ...
                    <div className="grid md:grid-cols-4 gap-12 mb-12">
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <p className="max-w-sm mb-6 leading-relaxed">
                                Connecting Thailand and Myanmar with reliable, fast, and secure logistics solutions. Your trusted partner in cross-border trade.
                            </p>
                        ...
                        <div>
                            ...
                            <ul className="space-y-4">
                                <li><a href="#" className="hover:text-white transition-colors">Cargo Shipping</a></li>
                                <li><a href="#" className="hover:text-white transition-colors">Buy for Me</a></li>
