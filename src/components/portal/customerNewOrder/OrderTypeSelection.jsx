      ...
      <CardContent className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <button
            ...
            className="group p-6 rounded-2xl border-2 border-slate-200  hover:border-blue-500 text-left transition-all duration-200 hover:bg-blue-50 "
          >
            ...
            <div className="mt-3 inline-flex items-center gap-1 text-xs text-slate-500 bg-slate-100  px-2 py-1 rounded-full">
          ...
          <button
            ...
            className="group p-6 rounded-2xl border-2 border-slate-200  hover:border-purple-500 text-left transition-all duration-200 hover:bg-purple-50 "
          >
