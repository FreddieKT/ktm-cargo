...
export default function BusinessSettingsTab({ businessSettings, setBusinessSettings, handleSaveBusinessSettings }) {
    return (
        <div className="space-y-6">
            ...
            <Card className="border-0 shadow-sm">
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="pt-4">
                        <Button onClick={handleSaveBusinessSettings} className="bg-amber-600 hover:bg-amber-700">
