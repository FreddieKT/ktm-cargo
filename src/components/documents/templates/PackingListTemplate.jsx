    ...
    return (
        <div className="max-w-[210mm] mx-auto bg-white text-slate-900 text-sm p-8">
            ...
            <div className="grid grid-cols-2 gap-12 mb-10">
                <div>
                    <h3 className="text-xs font-bold uppercase text-slate-400 tracking-wider mb-3">Shipment Reference</h3>
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-between border-b border-slate-100 pb-1">
                            ...
                            <span className="font-medium capitalize">{shipment.service_type?.replace(/_/g, ' ')}</span>
                        </div>
                        <div className="flex justify-between border-b border-slate-100 pb-1">
                ...
                <div>
                    <h3 className="text-xs font-bold uppercase text-slate-400 tracking-wider mb-3">Consignee</h3>
                    <div className="bg-slate-50 p-4 rounded border border-slate-100">
                        <p className="font-bold text-lg mb-1">{shipment.customer_name}</p>
                        <p className="text-slate-600 whitespace-pre-wrap text-sm">{shipment.delivery_address || 'Yangon, Myanmar'}</p>
            ...
            <table className="w-full mb-8">
                ...
                <tbody className="text-slate-700">
                    <tr className="border-b border-slate-100">
                        ...
                        <td className="py-4 px-4">
                            <p className="font-medium text-slate-900">{shipment.items_description || 'General Cargo'}</p>
                ...
                <tfoot>
                    <tr className="bg-slate-50">
                        <td colSpan="3" className="py-3 px-4 text-right font-bold uppercase text-slate-600">Total Gross Weight</td>
                        <td className="py-3 px-4 text-right font-bold text-lg text-slate-900">{shipment.weight_kg} kg</td>
                    </tr>
                </tfoot>
            </table>
