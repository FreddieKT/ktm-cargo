        ...
        <div className="max-w-[210mm] mx-auto bg-white text-slate-900 text-sm p-8 font-sans">
            ...
            <div className="grid grid-cols-2 gap-8 mb-8">
                <div className="border p-4 rounded">
                    <h3 className="text-xs font-bold uppercase text-slate-500 mb-2 border-b pb-1">Exporter</h3>
                    <p className="font-bold">{companyName}</p>
                    <p className="text-sm text-slate-600">{companyAddress}</p>
                </div>
                <div className="border p-4 rounded">
                    <h3 className="text-xs font-bold uppercase text-slate-500 mb-2 border-b pb-1">Importer / Consignee</h3>
            ...
            <div className="mb-8">
                ...
                <table className="w-full border-collapse border border-slate-300">
                    <thead className="bg-slate-50">
                        <tr>
                            <th className="border border-slate-300 py-2 px-3 text-left text-xs uppercase">Description</th>
                            <th className="border border-slate-300 py-2 px-3 text-center text-xs uppercase w-24">HS Code</th>
                            <th className="border border-slate-300 py-2 px-3 text-center text-xs uppercase w-20">Qty</th>
                            <th className="border border-slate-300 py-2 px-3 text-right text-xs uppercase w-24">Weight</th>
                            <th className="border border-slate-300 py-2 px-3 text-right text-xs uppercase w-32">Value (THB)</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td className="border border-slate-300 py-3 px-3 text-right">{shipment.weight_kg} kg</td>
                            <td className="border border-slate-300 py-3 px-3 text-right">฿{(shipment.total_amount || 0).toLocaleString()}</td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr className="bg-slate-50 font-bold">
                            <td colSpan="4" className="border border-slate-300 py-2 px-3 text-right uppercase text-xs">Total Declared Value</td>
                            <td className="border border-slate-300 py-2 px-3 text-right">฿{(shipment.total_amount || 0).toLocaleString()}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
            ...
            <div className="bg-amber-50 border border-amber-200 p-4 rounded mb-12 text-sm text-amber-900">
                ...
                <ol className="list-decimal list-inside space-y-1 ml-2">
                    ...
                    <li>The goods described above comply with all applicable export regulations of Thailand.</li>
