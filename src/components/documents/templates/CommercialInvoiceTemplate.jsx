    ...
    <div className="max-w-[210mm] mx-auto bg-white text-slate-900 text-sm p-8 font-serif">
      ...
      <table className="w-full border-collapse mb-8">
        <thead>
          <tr className="bg-slate-900 text-white">
            <th className="py-2 px-4 text-left font-medium text-xs uppercase">
              Item / Description
            </th>
        ...
        <tfoot>
          <tr className="bg-slate-50">
            <td colSpan="4" className="py-3 px-4 text-right font-bold uppercase">
              Total Invoice Value
            </td>
      ...
      <div className="mb-12">
        ...
        <p className="text-slate-600 text-xs leading-relaxed border p-4 rounded bg-slate-50">
          We hereby certify that this invoice shows the full value of the goods mentioned above and
          that such value is true and correct. We further certify that the goods are of Thailand
          origin.
        </p>
      </div>
